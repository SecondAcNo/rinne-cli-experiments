...
{
    public static class SaveDirectoryOnePassParallelPipe
    {
        public static async Task RunAsync(
            ...
            int level,
            int workers,
            SpaceFileMetaDbParallel? fileMetaDb,
            bool fullHashCheck,
                ...
                try
                {
                    await Parallel.ForEachAsync(
                        ...
                        async (path, token) =>
                        {
                            ...
                            // file_hash（中身だけ）と snapshot_file_hash（H_file_i）を同時計算する
                            ...
                            if (fileMetaDb is not null)
                            {
                                ...
                                // snapshotFileHashHex を追加で保存（H_file_i）
